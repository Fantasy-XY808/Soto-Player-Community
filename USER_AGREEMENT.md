# Soto Player-Community 用户协议与免责声明

**版本：v1.0**<br>
**生效日期：2026 年 5 月 29 日**<br>
**最近更新：2026 年 5 月 29 日**

欢迎使用 Soto Player-Community（以下简称“本软件”）。本软件是一款免费、开源的跨平台桌面音乐播放器，基于 SPlayer-Next 二次开发。在您下载、安装、复制、运行或以任何方式使用本软件之前，请务必认真阅读并充分理解本协议的全部内容，**尤其是以加粗或其他显著方式标识的免除或限制责任、争议解决与适用法律等条款**。
...
- **“开发者”**：指本软件的著作权人及开源贡献者，即 GitHub 用户 `Fantasy-XY808` 及项目贡献者；本软件基于 `SPlayer-Dev/SPlayer-Next` 二次开发，原上游著作权归 imsyy 及 SPlayer-Dev 组织所有。
...
- 不得对本软件附加任何与 AGPL-3.0 相抵触的额外限制。
  ...
  3.4 本软件官方源代码托管地址为：<https://github.com/Fantasy-XY808/Soto-Player-Community>；上游项目地址：<https://github.com/SPlayer-Dev/SPlayer-Next>。
...
7.2 “Soto Player-Community”“SPlayer”“SPlayer Next”等名称、标识及相关视觉设计的权益归各自开发者所有，未经许可，您不得用于可能造成混淆、误导或商业目的的场景。
...
10.1 **唯一官方渠道**：本软件仅通过 GitHub 官方仓库 <https://github.com/Fantasy-XY808/Soto-Player-Community> 发布；上游项目地址 <https://github.com/SPlayer-Dev/SPlayer-Next>。
...
- **GitHub 仓库**：<https://github.com/Fantasy-XY808/Soto-Player-Community>
- **问题反馈**：<https://github.com/Fantasy-XY808/Soto-Player-Community/issues>
- **QQ 群**：1043061896
