      ...
      >
        ...
        <SelectViewport class="p-1 max-h-60">
          <SelectItem
            ...
            :class="[
              'relative flex items-center h-8 px-2.5 pr-7 rounded-md cursor-pointer outline-none focus-visible:outline-none transition-colors duration-200 data-[disabled]:opacity-40 data-[disabled]:cursor-not-allowed data-[disabled]:pointer-events-none',
