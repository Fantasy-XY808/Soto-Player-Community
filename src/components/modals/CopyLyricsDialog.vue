...
import type { LyricCardStyle } from "@/utils/lyric/poster";
...
/** 卡片样式选项 */
const styleOptions: { value: LyricCardStyle; label: string }[] = [
  { value: "classic", label: "player.copyLyric.styleClassic" },
  { value: "compact", label: "player.copyLyric.styleCompact" },
  { value: "poster", label: "player.copyLyric.stylePoster" },
  { value: "minimal", label: "player.copyLyric.styleMinimal" },
];
const cardStyle = ref<LyricCardStyle>("classic");
        ...
        <div class="flex items-center gap-2 pt-1">
          ...
          <div class="flex items-center gap-1 flex-wrap">
            <SButton
              ...
              :key="opt.value"
              size="tiny"
              :type="cardStyle === opt.value ? 'primary' : 'default'"
              variant="secondary"
              @click="cardStyle = opt.value"
            >
              {{ t(opt.label) }}
            </SButton>
          </div>
